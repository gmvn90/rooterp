from replace_tags import reg_tons, replace_format_number
s = """
	<%--
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <tr>
                                            ...
                                            <td><label>${invoiceForm.item.approvalUser.userName}:<fmt:formatDate
                                                    pattern="dd-MMM-yy HH:mm:ss"
                                                    value="${invoiceForm.item.updated}"/></label></td>
