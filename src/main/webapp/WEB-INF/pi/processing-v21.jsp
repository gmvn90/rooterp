    ...
    <div class="right" style="width: 750px !important;margin-left: 0px; margin-right: 5px">
        <table class="instructionDetailStandard" style="padding: 0px; width: 100%">
            ...
            <form:form action="processing-v2.htm" method="post" commandName="piForm">
                ...
                <tr class="underline-bottom" style="border-bottom: solid black 1px">
                    ...
                    <td class="field_value" style="border-bottom: solid 0.5px; margin-bottom: 25px;">
                        <form:textarea path="requestRemark" id="requestRemark"></form:textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="field_value">
                        <input type="text" style="width: 100%" id="refNumber" value="${piForm.refNumber}"
                               disabled/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="field_value">
                        ${f:formatDateTime(piForm.createdDate)}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="field_value">
                        <form:select path="clientId" items="${clients}" itemValue="id" itemLabel="name"
                ...
                <tr>
                    ...
                    <td class="field_value">
                        <form:input path="clientRef" type="text" style="width: 100%" id="clientRef" value=""/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="field_value">
                        <form:select style="width: 100%" path="piType" id="piType">
                            <option value=""></option>
                ...
                <tr>
                    ...
                    <td class="field_value">
                        <form:select path="gradeMaster" items="${grades}" itemValue="id" itemLabel="name"
                ...
                <tr>
                    ...
                    <td class="field_value">
                        <form:input path="quantity" class="numberOnly" type="text" style="width: 50%"/>
                        Mts
                    </td>
                </tr>
            <tr>
                ...
                <td class="field_value"><fmt:formatNumber type="number" minFractionDigits="3" maxFractionDigits="3" value="${piForm.allocatedWeight}"/> Mts
                </td>
            </tr>
            <tr>
                <td></td>
                <td class="title">Inprocess:</td>
                <td class="field_value"><fmt:formatNumber type="number" minFractionDigits="3" maxFractionDigits="3" value="${piForm.inProcessWeight}"/> Mts
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="field_value"><fmt:formatNumber type="number" minFractionDigits="3" maxFractionDigits="3" value="${piForm.exProcessWeight}"/> Mts
                </td>
            </tr>
            <tr>
                <td></td>
                <td class="title">Pending:</td>
                <td class="field_value"><fmt:formatNumber type="number" minFractionDigits="3" maxFractionDigits="3" value="${piForm.pendingWeight}"/> Mts
                </td>
            </tr>
                ...
                <tr>
                    ...
                    <td class="field_value">
                        <form:select path="packingMaster" items="${packings}" itemValue="id" itemLabel="name"
                ...
                <tr>
                    ...
                    <td class="field_value">
                        <form:input path="creditDate" type="text" style="width: 100%" cssClass="js_date"
                ...
                <div class="right" style="width: 700px; margin-right: 3px; margin-top: 40px">
                    ...
                    <label class="">${piForm.user}:${f:formatDateTime(piForm.updatedDate)}</label>
