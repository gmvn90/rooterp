...
<jsp:include page="header.jsp">
    <jsp:param name="url" value="56"/>
    <jsp:param name="page" value="103"/>
</jsp:include>
<div style="width: 1400px ! important; padding: 15px; background: none repeat scroll 0% 0% white; height: auto; overflow: hidden; min-height: 400px"
    ...
    <form method="get" action="grade-master-list.htm" id="x-form">
        <input class="right" id="createNew" data-href="grade-master.htm" type="button" value="New Grade Master"/>


        <div style="width: 100%;overflow: hidden; height: auto; border-bottom: 1px solid #B8C2CC; padding-bottom: 10px">
            <h3>Grade Master list</h3>
            ...
            <table class="dataTableStandard" style="width: 100%">
                ...
                <c:forEach var="item" items="${grades}">
                    <tr class="go2Detail" data-href="grade-master.htm?id=${item.id}">
                        <td>${item.name}</td>
                        <td>${item.qualityMaster.name}</td>
