...
<head>
    ...
    <title>Grade Master Detail</title>
    <style>
        .styleTotal td {
...
<jsp:include page="header.jsp">
    <jsp:param name="url" value="57"/>
    <jsp:param name="page" value="104"/>
</jsp:include>
<div style="width: 600px ! important; padding: 15px; background: none repeat scroll 0% 0% white; height: auto; overflow: hidden"
    ...
    <form:form action="grade-master.htm" method="post" commandName="gradeMasterForm">
        <form:hidden path="item.id"/>
        <div style="width: 550px !important; min-height: 80px; height: auto; overflow: hidden;margin-right: 9px;"
             class="center">
            <p style="font-size: large">${gradeMasterForm.item.name}</p>
            <div class="" style="">
                <table class="instructionDetailStandard" style="padding: 20px; width: 100%">
                    ...
                    <tr>
                        ...
                        <td class="field_value">
                            <form:select path="item.qualityMaster" items="${qualities}"
                    ...
                    <tr>
                        ...
                        <td class="field_value">
                            <form:input path="item.description" type="text" style="width: 300px"/>
                        </td>
                    </tr>
                </table>
            </div>
