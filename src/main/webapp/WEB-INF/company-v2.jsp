...
<jsp:include page="header.jsp">
    <jsp:param name="url" value="45"/>
    <jsp:param name="page" value="89"/>
</jsp:include>
<div style="width: 600px ! important; padding: 15px; background: none repeat scroll 0% 0% white; height: auto; overflow: hidden"
    ...
    <form:form action="company-v2.htm" method="post" commandName="companyMasterForm">
        <form:hidden path="item.id"/>
        <div style="width: 550px !important; min-height: 80px; height: auto; overflow: hidden;margin-right: 9px;"
             class="center">
            <p style="font-size: large">${companyMasterForm.item.fullName}</p>
            <div class="" style="">
                <table class="instructionDetailStandard" style="padding: 20px; width: 100%">
                    ...
                    <tr>
                        ...
                        <td class="field_value">
                            <form:input path="item.taxCode" type="text" style="width: 300px"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="field_value">
                            <form:checkboxes path="item.companyTypes" items="${types}" itemLabel="name" itemValue="id" delimiter="<br/>"/>
                        </td>
                    </tr>
                </table>
            </div>
