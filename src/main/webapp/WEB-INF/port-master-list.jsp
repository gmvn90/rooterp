...
<jsp:include page="header.jsp">
    <jsp:param name="url" value="48"/>
    <jsp:param name="page" value="95"/>
</jsp:include>
<div style="width: 450px ! important; padding: 15px; background: none repeat scroll 0% 0% white; height: auto; overflow: hidden; min-height: 400px"
    ...
    <form method="get" action="port-master-list.htm" id="x-form">
        <input class="right" id="createNew" data-href="port-master.htm" type="button" value="New Port Master"/>


        <div style="width: 100%;overflow: hidden; height: auto; border-bottom: 1px solid #B8C2CC; padding-bottom: 10px">
            <h3>Port Master list</h3>
            ...
            <table class="dataTableStandard" style="width: 100%">
                ...
                <c:forEach var="item" items="${ports}">
                    <tr class="go2Detail" data-href="port-master.htm?id=${item.id}">
                        <td>${item.name}</td>
