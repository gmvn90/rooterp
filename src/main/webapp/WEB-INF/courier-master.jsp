...
<head>
    ...
    <title>Shipping Line Detail</title>
    <style>
        .styleTotal td {
...
<jsp:include page="header.jsp">
    <jsp:param name="url" value="53"/>
    <jsp:param name="page" value="100"/>
</jsp:include>
<div style="width: 600px ! important; padding: 15px; background: none repeat scroll 0% 0% white; height: auto; overflow: hidden"
    ...
    <form:form action="courier-master.htm" method="post" commandName="courierMasterForm">
        <form:hidden path="item.id"/>
        <div style="width: 550px !important; min-height: 80px; height: auto; overflow: hidden;margin-right: 9px;"
             class="center">
            <p style="font-size: large">${courierMasterForm.item.fullName}</p>
            <div class="" style="">
                <table class="instructionDetailStandard" style="padding: 20px; width: 100%">
                    ...
                    <tr>
                        <td class="title">Cost: (cost for sending sample)</td>
                        <td class="field_value">
                            <form:input path="item.cost" type="text" style="width: 300px"/>
                        </td>
                    </tr>
                </table>
            </div>
